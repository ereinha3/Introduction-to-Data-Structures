...
class T4_tree_empty_delete(unittest.TestCase):
...
class T5_tree_empty_delete(unittest.TestCase):
...
class T6_insert_and_postorder(unittest.TestCase):
    def test_postorder_traversal(self):
        ...
        tree.insert(5)
        tree.insert(35)
        tree_postorder = [node.data for node in tree.postorder()]
        self.assertEqual(tree_postorder, [5, 15, 10, 25, 35, 30, 20])

class T7_find_successor(unittest.TestCase):
    def test_empty(self):
        tree = rb_tree()
        tree.insert(1)
        tree.insert(2)
        tree.insert(3)
        self.assertEqual(3, tree.find_successor(2).data)
